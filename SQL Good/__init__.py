...
class Student(db.Model):
    ...
    def __init__(self, student_id_num, student_first_name, student_last_name, student_password, student_mobile, student_email, student_education_level, student_class):
...
def create_student_account():
    ...
    if request.method == 'POST' and create_student_form.validate():
        with app.app_context():
            ...
            student = Student(student_id_num, student_first_name, student_last_name, student_password, student_mobile, student_email, student_education_level, student_class)
...
def retrieve_student_account():
    ...
    return render_template('retrievestudent.html', count=len(student_data), student=student_data, student_classes=student_class, form=update_student_account)
